    ...
    def _assignment(self):
        ...
        if self._match("EQUAL"):
            ...
            if isinstance(expr, Variable):
                ...
                return Set(expr.callee, expr.index, value, expr.bracket_token)
    ...
    def _call(self):
        ...
        while True:
            if self._match("LEFT_PAREN"):
                ...
                self._consume("RIGHT_BRACKET", "Expect ']' after subscript index.")
                expr = Subscript(expr, bracket, index)
            else:
                break
        return expr
        ...
        if self._match("LEFT_BRACKET"):
            ...
            if not self._check("RIGHT_BRACKET"):
                while True:
                    ...
                    if not self._match("COMMA"):
                        break
            self._consume("RIGHT_BRACKET", "Expect ']' after array elements.")
            return ArrayLiteral(bracket, elements)
